...
DROP TABLE IF EXISTS "RequisicaoMinima";
DROP TABLE IF EXISTS "RequisicaoRecomendada";
...
CREATE TABLE "RequisicaoMinima" (
    "requisito" INTEGER,
    "jogo" INTEGER,
    PRIMARY KEY ("requisito", "jogo"),
    FOREIGN KEY ("requisito") REFERENCES "Requisito",
    FOREIGN KEY ("jogo") REFERENCES "Jogo"
);
CREATE TABLE "RequisicaoRecomendada" (
    "requisito" INTEGER,
    "jogo" INTEGER,
    PRIMARY KEY ("requisito", "jogo"),
    FOREIGN KEY ("requisito") REFERENCES "Requisito",
